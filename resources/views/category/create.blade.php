<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-2 md-4">
            ...
            <div>
                <h2 class="text-xl font-bold text-gray-800 dark:text-gray-200 tracking-light">Add Category</h2>
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{ route('categories.store') }}" method="POST" class="space-y-6">
                        ...
                        <div class="flex items-center justify-end gap-3 pt-2">
                            ...
                            <button type="submit" class="px-6 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium rounded-lg shadow-sm transition">Save Category</button>
                        </div>
                    </form>
