        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-200 tracking-tight">🏷️Product</h2>
                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Viewing product</p>
                    <p>All Products > #{{ $product->id }}</p>
                    ...
                    <div class="flex items-center gap-2 mt-4">
                        ...
                        <form action="{{ route('product.delete', $product->id) }}" method="POST"
                            ...
                            @method('DELETE')
                            <button type="submit"
                                class="inline-flex items-center gap-1 px-3 py-2 text-sm text-red-600 rounded-lg border border-red-300 dark:border-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 transition">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24"
                                    stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    {{-- Detail Card --}}
                    <div
                        class="rounded-lg border border-gray-200 dark:border-gray-700 divide-y divide-gray-100 dark:divide-gray-700 mt-6">
                        ...
                        <div class="flex items-center px-5 py-4">
                            ...
                            <div class="flex items-center gap-2.5">
                                <div
                                    class="h-7 w-7 rounded-full bg-indigo-500 dark:bg-indigo-600/80 flex items-center justify-center text-white text-xs font-bold uppercase">
